...
At=A.subs({t:pi , d:0 ,a:0 ,aph:0 })  #hacer por matrices de rotacion cuando se necesita rotacion de y en DH
'''
...
class JointSubscriber(Node):
    ...
    def sub_callback(self,msg):
        ...
        #T= A01*A12*A23*A34
        #T= A01*A12*A23*A34*A44p*A4p5
        T= A01*A12*A23*A34*A44p*A4p5*A55p*A5p6*A67*At
        


        #res=T.subs({t1:j1 ,t2:j2 ,t3:j3 ,t4:j4 ,t5:j5 ,t6:j6})
        #res=T.subs({t1:j1 ,t2:j2 ,t3:j3})
        #res=T.subs({t1:j1 ,t2:j2 ,t3:j3,t4:j4})
