...
T1=T.subs({theta:t1,w0:0,w1:-1,w2:0,qx:0, qy:0, qz:0})
T2=T.subs({theta:t2,w0:0,w1:-1,w2:0,qx:0.4, qy:0, qz:0})
T=T1*T2*M
res=T.subs({t1:0.391,t2:0.187})
...
pprint(T[0,3].subs({t1:0.391,t2:0.187}))
pprint(T[1,3].subs({t1:0.391,t2:0.187}))
pprint(T[2,3].subs({t1:0.391,t2:0.187}))
print(quaternion)
