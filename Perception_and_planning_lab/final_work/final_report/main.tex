...
\title{
    \vspace*{-2.25cm}  % Ajusta este valor para subir/bajar el título
    \begin{center}
...
\begin{document}
	...
	The implementation was developed in MATLAB and integrates seamlessly with the robot control system developed in the Control Laboratory module. \\Links is here: \\(\href{https://github.com/97hackbrian/RoboticsLab_DRM/tree/main/Control_lab/final_work}{GitHub: Control Final Project} \\ \href{https://github.com/97hackbrian/RoboticsLab_DRM/tree/main/Perception_and_planning_lab/final_work}{GitHub: Perception Final Project - Actual Report}).
...
|   |-- test_full_navigation.m      % Integration tests
	...
	The visualization results are shown in Figures~\ref{fig:rrt_tree}, \ref{fig:path_comparison}, \ref{fig:navigation}, and \ref{fig:labyrinth}. And the videos of the navigation are shown in~\href{https://drive.google.com/drive/folders/1W4KPytTfUeEQfveZ4PnIAgNbQ4YTOQv1?usp=sharing}{LINK}.
	\begin{figure}[htpb]
		\centering
	...
	\begin{itemize}
		...
		\item The complete \texttt{RoboticsLab\_DRM} repository: \href{https://github.com/97hackbrian/RoboticsLab_DRM.git}{LINK}
	\end{itemize}
