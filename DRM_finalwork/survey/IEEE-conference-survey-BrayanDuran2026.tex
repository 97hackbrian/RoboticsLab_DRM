...
\begin{enumerate}
    \item Providing a taxonomy of modern VLA models and their coupling with real-time 3DGS-based SLAM systems (e.g., MCGS-SLAM~\cite{cao2024mcgs}, MVS-GS~\cite{lee2025mvsgs}).
    \item Analysing computational feasibility on embedded hardware through LoRA and quantisation~\cite{zhang2025autonomous}.
    \item Proposing a closed-loop architecture unifying dense perception (3DGS), semantic cognition (VLA), and active exploration (Pred-NBV / GenNBV).
\end{enumerate}
